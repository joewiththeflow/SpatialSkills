...
//set up a question object to contain answerCanvas and QuestionCanvas
    //questionEx5 = new Question();

function setupQuestionEx5(exercise) {
    ...
    setUpPreviousNextButtonsEx5(exercise);
}

function setUpPreviousNextButtonsEx5(exercise){
    ...
    if(exercise.currentQuestion > 1){
        ...
        previousButton.onclick = function () {loadPreviousEx5(exercise)};
    }
    else {
    ...
    if(exercise.currentQuestion < exercise.questions.length){
        ...
        nextButton.onclick = function () {loadNextEx5(exercise)};
    }
    else {
...
function loadPreviousEx5(exercise) {
    //decrement currentQuestion by 1
    exercise.currentQuestion--;
    setupQuestionEx5(exercise);
}

function loadNextEx5(exercise) {
