...
//set up a question object to contain answerCanvas and QuestionCanvas
    //questionEx4 = new Question();

function setupQuestionEx4(exercise) {
    ...
    setUpPreviousNextButtonsEx4(exercise);
}

function setUpPreviousNextButtonsEx4(exercise){
    ...
    if(exercise.currentQuestion > 1){
        ...
        previousButton.onclick = function () {loadPreviousEx4(exercise)};
    }
    else {
    ...
    if(exercise.currentQuestion < exercise.questions.length){
        ...
        nextButton.onclick = function () {loadNextEx4(exercise)};
    }
    else {
...
function loadPreviousEx4(exercise) {
    //decrement currentQuestion by 1
    exercise.currentQuestion--;
    setupQuestionEx4(exercise);
}

function loadNextEx4(exercise) {
